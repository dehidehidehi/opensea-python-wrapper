...
class OrderResponse(BaseResponse):
    ...
    def _set_optional_attrs(self):
        created_date = self._json['created_date']
        closing_date = self._json['closing_date']
        self.created_date: Optional[datetime] = datetime.fromisoformat(created_date) if created_date else None
        self.closing_date: Optional[datetime] = datetime.fromisoformat(closing_date) if closing_date else None
