...
class _Collection:
    ...
    def __str__(self) -> str:
        return f"({_Collection.__name__}, {self.name=}, {self.short_description=})"

    def __post_init__(self):
        self.primary_asset_contracts = self._json["primary_asset_contracts"]
        self.traits = self._json["traits"]
